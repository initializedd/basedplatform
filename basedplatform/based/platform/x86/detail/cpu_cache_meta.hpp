...
namespace based::platform::x86::detail {
    ...
    cpu_cache_meta_mask supported_cpu_cache_meta(const std::uint32_t max_leaf) noexcept {
        ...
        if (max_leaf >= 0x04) {
            ...
            // ebx register
            if (leaf_0x04.ebx_bit( 0u)) result |= system_coherency_bytes_bit_0;
            if (leaf_0x04.ebx_bit( 1u)) result |= system_coherency_bytes_bit_1;
            if (leaf_0x04.ebx_bit( 2u)) result |= system_coherency_bytes_bit_2;
            if (leaf_0x04.ebx_bit( 3u)) result |= system_coherency_bytes_bit_3;
            if (leaf_0x04.ebx_bit( 4u)) result |= system_coherency_bytes_bit_4;
            if (leaf_0x04.ebx_bit( 5u)) result |= system_coherency_bytes_bit_5;
            if (leaf_0x04.ebx_bit( 6u)) result |= system_coherency_bytes_bit_6;
            if (leaf_0x04.ebx_bit( 7u)) result |= system_coherency_bytes_bit_7;
            if (leaf_0x04.ebx_bit( 8u)) result |= system_coherency_bytes_bit_8;
            ...
            if (leaf_0x04.ebx_bit(25u)) result |= ways_of_cache_associativity_bit_3;
            if (leaf_0x04.ebx_bit(26u)) result |= ways_of_cache_associativity_bit_4;
            if (leaf_0x04.ebx_bit(27u)) result |= ways_of_cache_associativity_bit_5;
            if (leaf_0x04.ebx_bit(28u)) result |= ways_of_cache_associativity_bit_6;
            if (leaf_0x04.ebx_bit(29u)) result |= ways_of_cache_associativity_bit_7;
            if (leaf_0x04.ebx_bit(30u)) result |= ways_of_cache_associativity_bit_8;
            if (leaf_0x04.ebx_bit(31u)) result |= ways_of_cache_associativity_bit_9;
        }
