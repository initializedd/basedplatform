...
namespace based::platform::x86::detail {
    ...
    [[nodiscard]]
    inline cpu_soc_vendor_identifier_mask supported_cpu_soc_vendor_identifiers(const std::uint32_t max_leaf) noexcept {
        ...
        if (max_leaf >= 0x17) {
            ...
            // ebx register
            if (leaf_0x17.ebx_bit( 0u)) result |= soc_vendor_id_bit_0;
            if (leaf_0x17.ebx_bit( 1u)) result |= soc_vendor_id_bit_1;
            if (leaf_0x17.ebx_bit( 2u)) result |= soc_vendor_id_bit_2;
            if (leaf_0x17.ebx_bit( 3u)) result |= soc_vendor_id_bit_3;
            if (leaf_0x17.ebx_bit( 4u)) result |= soc_vendor_id_bit_4;
            if (leaf_0x17.ebx_bit( 5u)) result |= soc_vendor_id_bit_5;
            if (leaf_0x17.ebx_bit( 6u)) result |= soc_vendor_id_bit_6;
            if (leaf_0x17.ebx_bit( 7u)) result |= soc_vendor_id_bit_7;
            if (leaf_0x17.ebx_bit( 8u)) result |= soc_vendor_id_bit_8;
            if (leaf_0x17.ebx_bit( 9u)) result |= soc_vendor_id_bit_9;
            if (leaf_0x17.ebx_bit(10u)) result |= soc_vendor_id_bit_10;
            if (leaf_0x17.ebx_bit(11u)) result |= soc_vendor_id_bit_11;
            if (leaf_0x17.ebx_bit(12u)) result |= soc_vendor_id_bit_12;
            if (leaf_0x17.ebx_bit(13u)) result |= soc_vendor_id_bit_13;
            if (leaf_0x17.ebx_bit(14u)) result |= soc_vendor_id_bit_14;
            if (leaf_0x17.ebx_bit(15u)) result |= soc_vendor_id_bit_15;
            if (leaf_0x17.ebx_bit(16u)) result |= soc_vendor_id_scheme;
        }
