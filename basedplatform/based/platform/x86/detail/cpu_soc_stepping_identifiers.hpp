...
namespace based::platform::x86::detail {
    ...
    cpu_soc_stepping_identifier_mask supported_cpu_soc_stepping_identifiers(const std::uint32_t max_leaf) noexcept {
        ...
        if (max_leaf >= 0x17) {
            using enum cpu_soc_stepping_identifier;
            const auto leaf_0x17 = cpu_id(0x17, 0x00);

            // edx register
            if (leaf_0x17.ecx_bit( 0u)) result |= soc_stepping_id_bit_0;
            if (leaf_0x17.ecx_bit( 1u)) result |= soc_stepping_id_bit_1;
            if (leaf_0x17.ecx_bit( 2u)) result |= soc_stepping_id_bit_2;
            if (leaf_0x17.ecx_bit( 3u)) result |= soc_stepping_id_bit_3;
            if (leaf_0x17.ecx_bit( 4u)) result |= soc_stepping_id_bit_4;
            if (leaf_0x17.ecx_bit( 5u)) result |= soc_stepping_id_bit_5;
            if (leaf_0x17.ecx_bit( 6u)) result |= soc_stepping_id_bit_6;
            if (leaf_0x17.ecx_bit( 7u)) result |= soc_stepping_id_bit_7;
            if (leaf_0x17.ecx_bit( 8u)) result |= soc_stepping_id_bit_8;
            if (leaf_0x17.ecx_bit( 9u)) result |= soc_stepping_id_bit_9;
            if (leaf_0x17.ecx_bit(10u)) result |= soc_stepping_id_bit_10;
            if (leaf_0x17.ecx_bit(11u)) result |= soc_stepping_id_bit_11;
            if (leaf_0x17.ecx_bit(12u)) result |= soc_stepping_id_bit_12;
            if (leaf_0x17.ecx_bit(13u)) result |= soc_stepping_id_bit_13;
            if (leaf_0x17.ecx_bit(14u)) result |= soc_stepping_id_bit_14;
            if (leaf_0x17.ecx_bit(15u)) result |= soc_stepping_id_bit_15;
            if (leaf_0x17.ecx_bit(16u)) result |= soc_stepping_id_bit_16;
            if (leaf_0x17.ecx_bit(17u)) result |= soc_stepping_id_bit_17;
            if (leaf_0x17.ecx_bit(18u)) result |= soc_stepping_id_bit_18;
            if (leaf_0x17.ecx_bit(19u)) result |= soc_stepping_id_bit_19;
            if (leaf_0x17.ecx_bit(20u)) result |= soc_stepping_id_bit_20;
            if (leaf_0x17.ecx_bit(21u)) result |= soc_stepping_id_bit_21;
            if (leaf_0x17.ecx_bit(22u)) result |= soc_stepping_id_bit_22;
            if (leaf_0x17.ecx_bit(23u)) result |= soc_stepping_id_bit_23;
            if (leaf_0x17.ecx_bit(24u)) result |= soc_stepping_id_bit_24;
            if (leaf_0x17.ecx_bit(25u)) result |= soc_stepping_id_bit_25;
            if (leaf_0x17.ecx_bit(26u)) result |= soc_stepping_id_bit_26;
            if (leaf_0x17.ecx_bit(27u)) result |= soc_stepping_id_bit_27;
            if (leaf_0x17.ecx_bit(28u)) result |= soc_stepping_id_bit_28;
            if (leaf_0x17.ecx_bit(29u)) result |= soc_stepping_id_bit_29;
            if (leaf_0x17.ecx_bit(30u)) result |= soc_stepping_id_bit_30;
            if (leaf_0x17.ecx_bit(31u)) result |= soc_stepping_id_bit_31;
        }
