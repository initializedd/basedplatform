...
namespace based::platform::x86::detail {
    ...
    inline cpu_address_limit_mask supported_cpu_address_limits(const std::uint32_t max_leaf) noexcept {
        ...
        if (max_leaf >= 0x80000008) {
            using enum cpu_address_limit;
            const auto leaf_0x80000008 = cpu_id(0x80000008, 0x00);

            // edx register
            if (leaf_0x80000008.edx_bit( 0u)) result |= invlpgb_max_page_count_bit_0;
            if (leaf_0x80000008.edx_bit( 1u)) result |= invlpgb_max_page_count_bit_1;
            if (leaf_0x80000008.edx_bit( 2u)) result |= invlpgb_max_page_count_bit_2;
            if (leaf_0x80000008.edx_bit( 3u)) result |= invlpgb_max_page_count_bit_3;
            if (leaf_0x80000008.edx_bit( 4u)) result |= invlpgb_max_page_count_bit_4;
            if (leaf_0x80000008.edx_bit( 5u)) result |= invlpgb_max_page_count_bit_5;
            if (leaf_0x80000008.edx_bit( 6u)) result |= invlpgb_max_page_count_bit_6;
            if (leaf_0x80000008.edx_bit( 7u)) result |= invlpgb_max_page_count_bit_7;
            if (leaf_0x80000008.edx_bit( 8u)) result |= invlpgb_max_page_count_bit_8;
            if (leaf_0x80000008.edx_bit( 9u)) result |= invlpgb_max_page_count_bit_9;
            if (leaf_0x80000008.edx_bit(10u)) result |= invlpgb_max_page_count_bit_10;
            if (leaf_0x80000008.edx_bit(11u)) result |= invlpgb_max_page_count_bit_11;
            if (leaf_0x80000008.edx_bit(12u)) result |= invlpgb_max_page_count_bit_12;
            if (leaf_0x80000008.edx_bit(13u)) result |= invlpgb_max_page_count_bit_13;
            if (leaf_0x80000008.edx_bit(14u)) result |= invlpgb_max_page_count_bit_14;
            if (leaf_0x80000008.edx_bit(15u)) result |= invlpgb_max_page_count_bit_15;
            if (leaf_0x80000008.edx_bit(16u)) result |= rdpru_max_ecx_value_bit_0;
            if (leaf_0x80000008.edx_bit(17u)) result |= rdpru_max_ecx_value_bit_1;
            if (leaf_0x80000008.edx_bit(18u)) result |= rdpru_max_ecx_value_bit_2;
            if (leaf_0x80000008.edx_bit(19u)) result |= rdpru_max_ecx_value_bit_3;
            if (leaf_0x80000008.edx_bit(20u)) result |= rdpru_max_ecx_value_bit_4;
            if (leaf_0x80000008.edx_bit(21u)) result |= rdpru_max_ecx_value_bit_5;
            if (leaf_0x80000008.edx_bit(22u)) result |= rdpru_max_ecx_value_bit_6;
            if (leaf_0x80000008.edx_bit(23u)) result |= rdpru_max_ecx_value_bit_7;
            if (leaf_0x80000008.edx_bit(24u)) result |= rdpru_max_ecx_value_bit_8;
            if (leaf_0x80000008.edx_bit(25u)) result |= rdpru_max_ecx_value_bit_9;
            if (leaf_0x80000008.edx_bit(26u)) result |= rdpru_max_ecx_value_bit_10;
            if (leaf_0x80000008.edx_bit(27u)) result |= rdpru_max_ecx_value_bit_11;
            if (leaf_0x80000008.edx_bit(28u)) result |= rdpru_max_ecx_value_bit_12;
            if (leaf_0x80000008.edx_bit(29u)) result |= rdpru_max_ecx_value_bit_13;
            if (leaf_0x80000008.edx_bit(30u)) result |= rdpru_max_ecx_value_bit_14;
            if (leaf_0x80000008.edx_bit(31u)) result |= rdpru_max_ecx_value_bit_15;
        }
