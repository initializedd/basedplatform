...
namespace based::platform::x86::detail {
    ...
    cpu_sgx_epc_info_mask supported_cpu_sgx_epc_info(const std::uint32_t max_leaf) noexcept {
        ...
        if (max_leaf >= 0x12) {
            using enum cpu_sgx_epc_info;
            const auto leaf_0x12 = cpu_id(0x12, 0x02);

            // eax register
            if (leaf_0x12.eax_bit( 0u)) result |= sub_leaf_type_bit_0;
            if (leaf_0x12.eax_bit( 1u)) result |= sub_leaf_type_bit_1;
            if (leaf_0x12.eax_bit( 2u)) result |= sub_leaf_type_bit_2;
            if (leaf_0x12.eax_bit( 3u)) result |= sub_leaf_type_bit_3;
            if (leaf_0x12.eax_bit(12u)) result |= physical_base_address_bit_0;
            if (leaf_0x12.eax_bit(13u)) result |= physical_base_address_bit_1;
            if (leaf_0x12.eax_bit(14u)) result |= physical_base_address_bit_2;
            if (leaf_0x12.eax_bit(15u)) result |= physical_base_address_bit_3;
            if (leaf_0x12.eax_bit(16u)) result |= physical_base_address_bit_4;
            if (leaf_0x12.eax_bit(17u)) result |= physical_base_address_bit_5;
            if (leaf_0x12.eax_bit(18u)) result |= physical_base_address_bit_6;
            if (leaf_0x12.eax_bit(19u)) result |= physical_base_address_bit_7;
            if (leaf_0x12.eax_bit(20u)) result |= physical_base_address_bit_8;
            if (leaf_0x12.eax_bit(21u)) result |= physical_base_address_bit_9;
            if (leaf_0x12.eax_bit(22u)) result |= physical_base_address_bit_10;
            if (leaf_0x12.eax_bit(23u)) result |= physical_base_address_bit_11;
            if (leaf_0x12.eax_bit(24u)) result |= physical_base_address_bit_12;
            if (leaf_0x12.eax_bit(25u)) result |= physical_base_address_bit_13;
            if (leaf_0x12.eax_bit(26u)) result |= physical_base_address_bit_14;
            if (leaf_0x12.eax_bit(27u)) result |= physical_base_address_bit_15;
            if (leaf_0x12.eax_bit(28u)) result |= physical_base_address_bit_16;
            if (leaf_0x12.eax_bit(29u)) result |= physical_base_address_bit_17;
            if (leaf_0x12.eax_bit(30u)) result |= physical_base_address_bit_18;
            if (leaf_0x12.eax_bit(31u)) result |= physical_base_address_bit_19;
        }
    ...
    cpu_sgx_epc_physical_base_address_remainder_mask supported_cpu_sgx_epc_physical_base_address_remainder(const std::uint32_t max_leaf) noexcept {
        ...
        if (max_leaf >= 0x12) {
            using enum cpu_sgx_epc_physical_base_address_remainder;
            const auto leaf_0x12 = cpu_id(0x12, 0x02);

            // ebx register
            if (leaf_0x12.ebx_bit( 0u)) result |= physical_base_address_bit_0;
            if (leaf_0x12.ebx_bit( 1u)) result |= physical_base_address_bit_1;
            if (leaf_0x12.ebx_bit( 2u)) result |= physical_base_address_bit_2;
            if (leaf_0x12.ebx_bit( 3u)) result |= physical_base_address_bit_3;
            if (leaf_0x12.ebx_bit( 4u)) result |= physical_base_address_bit_4;
            if (leaf_0x12.ebx_bit( 5u)) result |= physical_base_address_bit_5;
            if (leaf_0x12.ebx_bit( 6u)) result |= physical_base_address_bit_6;
            if (leaf_0x12.ebx_bit( 7u)) result |= physical_base_address_bit_7;
            if (leaf_0x12.ebx_bit( 8u)) result |= physical_base_address_bit_8;
            if (leaf_0x12.ebx_bit( 9u)) result |= physical_base_address_bit_9;
            if (leaf_0x12.ebx_bit(10u)) result |= physical_base_address_bit_10;
            if (leaf_0x12.ebx_bit(11u)) result |= physical_base_address_bit_11;
            if (leaf_0x12.ebx_bit(12u)) result |= physical_base_address_bit_12;
            if (leaf_0x12.ebx_bit(13u)) result |= physical_base_address_bit_13;
            if (leaf_0x12.ebx_bit(14u)) result |= physical_base_address_bit_14;
            if (leaf_0x12.ebx_bit(15u)) result |= physical_base_address_bit_15;
            if (leaf_0x12.ebx_bit(16u)) result |= physical_base_address_bit_16;
            if (leaf_0x12.ebx_bit(17u)) result |= physical_base_address_bit_17;
            if (leaf_0x12.ebx_bit(18u)) result |= physical_base_address_bit_18;
            if (leaf_0x12.ebx_bit(19u)) result |= physical_base_address_bit_19;
        }
    ...
    cpu_sgx_epc_section_property_mask supported_cpu_sgx_epc_section_properties(const std::uint32_t max_leaf) noexcept {
        ...
        if (max_leaf >= 0x12) {
            using enum cpu_sgx_epc_section_property;
            const auto leaf_0x12 = cpu_id(0x12, 0x02);

            // ecx register
            if (leaf_0x12.ecx_bit( 0u)) result |= property_bit_0;
            if (leaf_0x12.ecx_bit( 1u)) result |= property_bit_1;
            if (leaf_0x12.ecx_bit( 2u)) result |= property_bit_2;
            if (leaf_0x12.ecx_bit( 3u)) result |= property_bit_3;
            if (leaf_0x12.ecx_bit(12u)) result |= section_size_bit_0;
            if (leaf_0x12.ecx_bit(13u)) result |= section_size_bit_1;
            if (leaf_0x12.ecx_bit(14u)) result |= section_size_bit_2;
            if (leaf_0x12.ecx_bit(15u)) result |= section_size_bit_3;
            if (leaf_0x12.ecx_bit(16u)) result |= section_size_bit_4;
            if (leaf_0x12.ecx_bit(17u)) result |= section_size_bit_5;
            if (leaf_0x12.ecx_bit(18u)) result |= section_size_bit_6;
            if (leaf_0x12.ecx_bit(19u)) result |= section_size_bit_7;
            if (leaf_0x12.ecx_bit(20u)) result |= section_size_bit_8;
            if (leaf_0x12.ecx_bit(21u)) result |= section_size_bit_9;
            if (leaf_0x12.ecx_bit(22u)) result |= section_size_bit_10;
            if (leaf_0x12.ecx_bit(23u)) result |= section_size_bit_11;
            if (leaf_0x12.ecx_bit(24u)) result |= section_size_bit_12;
            if (leaf_0x12.ecx_bit(25u)) result |= section_size_bit_13;
            if (leaf_0x12.ecx_bit(26u)) result |= section_size_bit_14;
            if (leaf_0x12.ecx_bit(27u)) result |= section_size_bit_15;
            if (leaf_0x12.ecx_bit(28u)) result |= section_size_bit_16;
            if (leaf_0x12.ecx_bit(29u)) result |= section_size_bit_17;
            if (leaf_0x12.ecx_bit(30u)) result |= section_size_bit_18;
            if (leaf_0x12.ecx_bit(31u)) result |= section_size_bit_19;
        }
    ...
    cpu_sgx_epc_section_size_remainder_mask supported_cpu_sgx_epc_section_size_remainder(const std::uint32_t max_leaf) noexcept {
        ...
        if (max_leaf >= 0x12) {
            using enum cpu_sgx_epc_section_size_remainder;
            const auto leaf_0x12 = cpu_id(0x12, 0x02);

            // edx register
            if (leaf_0x12.edx_bit( 0u)) result |= section_size_bit_0;
            if (leaf_0x12.edx_bit( 1u)) result |= section_size_bit_1;
            if (leaf_0x12.edx_bit( 2u)) result |= section_size_bit_2;
            if (leaf_0x12.edx_bit( 3u)) result |= section_size_bit_3;
            if (leaf_0x12.edx_bit( 4u)) result |= section_size_bit_4;
            if (leaf_0x12.edx_bit( 5u)) result |= section_size_bit_5;
            if (leaf_0x12.edx_bit( 6u)) result |= section_size_bit_6;
            if (leaf_0x12.edx_bit( 7u)) result |= section_size_bit_7;
            if (leaf_0x12.edx_bit( 8u)) result |= section_size_bit_8;
            if (leaf_0x12.edx_bit( 9u)) result |= section_size_bit_9;
            if (leaf_0x12.edx_bit(10u)) result |= section_size_bit_10;
            if (leaf_0x12.edx_bit(11u)) result |= section_size_bit_11;
            if (leaf_0x12.edx_bit(12u)) result |= section_size_bit_12;
            if (leaf_0x12.edx_bit(13u)) result |= section_size_bit_13;
            if (leaf_0x12.edx_bit(14u)) result |= section_size_bit_14;
            if (leaf_0x12.edx_bit(15u)) result |= section_size_bit_15;
            if (leaf_0x12.edx_bit(16u)) result |= section_size_bit_16;
            if (leaf_0x12.edx_bit(17u)) result |= section_size_bit_17;
            if (leaf_0x12.edx_bit(18u)) result |= section_size_bit_18;
            if (leaf_0x12.edx_bit(19u)) result |= section_size_bit_19;
        }
