...
namespace based::platform::x86::detail {
    ...
    cpu_tsc_to_core_crystal_clock_frequency_denominator_mask supported_cpu_tsc_to_crystal_clock_frequency_denominator(const std::uint32_t max_leaf) noexcept {
        ...
        if (max_leaf >= 0x15) {
            using enum cpu_tsc_to_core_crystal_clock_frequency_denominator;
            const auto leaf_0x15 = cpu_id(0x15, 0x00);

            // eax register
            if (leaf_0x15.eax_bit( 0u)) result |= ratio_bit_0;
            if (leaf_0x15.eax_bit( 1u)) result |= ratio_bit_1;
            if (leaf_0x15.eax_bit( 2u)) result |= ratio_bit_2;
            if (leaf_0x15.eax_bit( 3u)) result |= ratio_bit_3;
            if (leaf_0x15.eax_bit( 4u)) result |= ratio_bit_4;
            if (leaf_0x15.eax_bit( 5u)) result |= ratio_bit_5;
            if (leaf_0x15.eax_bit( 6u)) result |= ratio_bit_6;
            if (leaf_0x15.eax_bit( 7u)) result |= ratio_bit_7;
            if (leaf_0x15.eax_bit( 8u)) result |= ratio_bit_8;
            if (leaf_0x15.eax_bit( 9u)) result |= ratio_bit_9;
            if (leaf_0x15.eax_bit(10u)) result |= ratio_bit_10;
            if (leaf_0x15.eax_bit(11u)) result |= ratio_bit_11;
            if (leaf_0x15.eax_bit(12u)) result |= ratio_bit_12;
            if (leaf_0x15.eax_bit(13u)) result |= ratio_bit_13;
            if (leaf_0x15.eax_bit(14u)) result |= ratio_bit_14;
            if (leaf_0x15.eax_bit(15u)) result |= ratio_bit_15;
            if (leaf_0x15.eax_bit(16u)) result |= ratio_bit_16;
            if (leaf_0x15.eax_bit(17u)) result |= ratio_bit_17;
            if (leaf_0x15.eax_bit(18u)) result |= ratio_bit_18;
            if (leaf_0x15.eax_bit(19u)) result |= ratio_bit_19;
            if (leaf_0x15.eax_bit(20u)) result |= ratio_bit_20;
            if (leaf_0x15.eax_bit(21u)) result |= ratio_bit_21;
            if (leaf_0x15.eax_bit(22u)) result |= ratio_bit_22;
            if (leaf_0x15.eax_bit(23u)) result |= ratio_bit_23;
            if (leaf_0x15.eax_bit(24u)) result |= ratio_bit_24;
            if (leaf_0x15.eax_bit(25u)) result |= ratio_bit_25;
            if (leaf_0x15.eax_bit(26u)) result |= ratio_bit_26;
            if (leaf_0x15.eax_bit(27u)) result |= ratio_bit_27;
            if (leaf_0x15.eax_bit(28u)) result |= ratio_bit_28;
            if (leaf_0x15.eax_bit(29u)) result |= ratio_bit_29;
            if (leaf_0x15.eax_bit(30u)) result |= ratio_bit_30;
            if (leaf_0x15.eax_bit(31u)) result |= ratio_bit_31;
        }
    ...
    cpu_tsc_to_core_crystal_clock_frequency_numerator_mask supported_cpu_tsc_to_crystal_clock_frequency_numerator(const std::uint32_t max_leaf) noexcept {
        ...
        if (max_leaf >= 0x15) {
            using enum cpu_tsc_to_core_crystal_clock_frequency_numerator;
            const auto leaf_0x15 = cpu_id(0x15, 0x00);

            // ebx register
            if (leaf_0x15.ebx_bit( 0u)) result |= ratio_bit_0;
            if (leaf_0x15.ebx_bit( 1u)) result |= ratio_bit_1;
            if (leaf_0x15.ebx_bit( 2u)) result |= ratio_bit_2;
            if (leaf_0x15.ebx_bit( 3u)) result |= ratio_bit_3;
            if (leaf_0x15.ebx_bit( 4u)) result |= ratio_bit_4;
            if (leaf_0x15.ebx_bit( 5u)) result |= ratio_bit_5;
            if (leaf_0x15.ebx_bit( 6u)) result |= ratio_bit_6;
            if (leaf_0x15.ebx_bit( 7u)) result |= ratio_bit_7;
            if (leaf_0x15.ebx_bit( 8u)) result |= ratio_bit_8;
            if (leaf_0x15.ebx_bit( 9u)) result |= ratio_bit_9;
            if (leaf_0x15.ebx_bit(10u)) result |= ratio_bit_10;
            if (leaf_0x15.ebx_bit(11u)) result |= ratio_bit_11;
            if (leaf_0x15.ebx_bit(12u)) result |= ratio_bit_12;
            if (leaf_0x15.ebx_bit(13u)) result |= ratio_bit_13;
            if (leaf_0x15.ebx_bit(14u)) result |= ratio_bit_14;
            if (leaf_0x15.ebx_bit(15u)) result |= ratio_bit_15;
            if (leaf_0x15.ebx_bit(16u)) result |= ratio_bit_16;
            if (leaf_0x15.ebx_bit(17u)) result |= ratio_bit_17;
            if (leaf_0x15.ebx_bit(18u)) result |= ratio_bit_18;
            if (leaf_0x15.ebx_bit(19u)) result |= ratio_bit_19;
            if (leaf_0x15.ebx_bit(20u)) result |= ratio_bit_20;
            if (leaf_0x15.ebx_bit(21u)) result |= ratio_bit_21;
            if (leaf_0x15.ebx_bit(22u)) result |= ratio_bit_22;
            if (leaf_0x15.ebx_bit(23u)) result |= ratio_bit_23;
            if (leaf_0x15.ebx_bit(24u)) result |= ratio_bit_24;
            if (leaf_0x15.ebx_bit(25u)) result |= ratio_bit_25;
            if (leaf_0x15.ebx_bit(26u)) result |= ratio_bit_26;
            if (leaf_0x15.ebx_bit(27u)) result |= ratio_bit_27;
            if (leaf_0x15.ebx_bit(28u)) result |= ratio_bit_28;
            if (leaf_0x15.ebx_bit(29u)) result |= ratio_bit_29;
            if (leaf_0x15.ebx_bit(30u)) result |= ratio_bit_30;
            if (leaf_0x15.ebx_bit(31u)) result |= ratio_bit_31;
        }
    ...
    cpu_core_crystal_clock_frequency_mask supported_cpu_core_crystal_clock_frequency(const std::uint32_t max_leaf) noexcept {
        ...
        if (max_leaf >= 0x15) {
            using enum cpu_core_crystal_clock_frequency;
            const auto leaf_0x15 = cpu_id(0x15, 0x00);

            // ecx register
            if (leaf_0x15.ecx_bit( 0u)) result |= frequency_bit_0;
            if (leaf_0x15.ecx_bit( 1u)) result |= frequency_bit_1;
            if (leaf_0x15.ecx_bit( 2u)) result |= frequency_bit_2;
            if (leaf_0x15.ecx_bit( 3u)) result |= frequency_bit_3;
            if (leaf_0x15.ecx_bit( 4u)) result |= frequency_bit_4;
            if (leaf_0x15.ecx_bit( 5u)) result |= frequency_bit_5;
            if (leaf_0x15.ecx_bit( 6u)) result |= frequency_bit_6;
            if (leaf_0x15.ecx_bit( 7u)) result |= frequency_bit_7;
            if (leaf_0x15.ecx_bit( 8u)) result |= frequency_bit_8;
            if (leaf_0x15.ecx_bit( 9u)) result |= frequency_bit_9;
            if (leaf_0x15.ecx_bit(10u)) result |= frequency_bit_10;
            if (leaf_0x15.ecx_bit(11u)) result |= frequency_bit_11;
            if (leaf_0x15.ecx_bit(12u)) result |= frequency_bit_12;
            if (leaf_0x15.ecx_bit(13u)) result |= frequency_bit_13;
            if (leaf_0x15.ecx_bit(14u)) result |= frequency_bit_14;
            if (leaf_0x15.ecx_bit(15u)) result |= frequency_bit_15;
            if (leaf_0x15.ecx_bit(16u)) result |= frequency_bit_16;
            if (leaf_0x15.ecx_bit(17u)) result |= frequency_bit_17;
            if (leaf_0x15.ecx_bit(18u)) result |= frequency_bit_18;
            if (leaf_0x15.ecx_bit(19u)) result |= frequency_bit_19;
            if (leaf_0x15.ecx_bit(20u)) result |= frequency_bit_20;
            if (leaf_0x15.ecx_bit(21u)) result |= frequency_bit_21;
            if (leaf_0x15.ecx_bit(22u)) result |= frequency_bit_22;
            if (leaf_0x15.ecx_bit(23u)) result |= frequency_bit_23;
            if (leaf_0x15.ecx_bit(24u)) result |= frequency_bit_24;
            if (leaf_0x15.ecx_bit(25u)) result |= frequency_bit_25;
            if (leaf_0x15.ecx_bit(26u)) result |= frequency_bit_26;
            if (leaf_0x15.ecx_bit(27u)) result |= frequency_bit_27;
            if (leaf_0x15.ecx_bit(28u)) result |= frequency_bit_28;
            if (leaf_0x15.ecx_bit(29u)) result |= frequency_bit_29;
            if (leaf_0x15.ecx_bit(30u)) result |= frequency_bit_30;
            if (leaf_0x15.ecx_bit(31u)) result |= frequency_bit_31;
        }
