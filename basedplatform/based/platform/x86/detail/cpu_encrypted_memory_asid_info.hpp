...
namespace based::platform::x86::detail {
    ...
    inline cpu_encrypted_memory_max_asid_info_mask supported_cpu_encrypted_memory_max_asid_info(const std::uint32_t max_leaf) noexcept {
        ...
        if (max_leaf >= 0x8000001F) {
            ...
            // ecx register
            if (leaf_0x8000001f.ecx_bit( 0u)) result |= max_asid_value_bit_0;
            if (leaf_0x8000001f.ecx_bit( 1u)) result |= max_asid_value_bit_1;
            if (leaf_0x8000001f.ecx_bit( 2u)) result |= max_asid_value_bit_2;
            if (leaf_0x8000001f.ecx_bit( 3u)) result |= max_asid_value_bit_3;
            if (leaf_0x8000001f.ecx_bit( 4u)) result |= max_asid_value_bit_4;
            if (leaf_0x8000001f.ecx_bit( 5u)) result |= max_asid_value_bit_5;
            if (leaf_0x8000001f.ecx_bit( 6u)) result |= max_asid_value_bit_6;
            if (leaf_0x8000001f.ecx_bit( 7u)) result |= max_asid_value_bit_7;
            if (leaf_0x8000001f.ecx_bit( 8u)) result |= max_asid_value_bit_8;
            if (leaf_0x8000001f.ecx_bit( 9u)) result |= max_asid_value_bit_9;
            if (leaf_0x8000001f.ecx_bit(10u)) result |= max_asid_value_bit_10;
            if (leaf_0x8000001f.ecx_bit(11u)) result |= max_asid_value_bit_11;
            if (leaf_0x8000001f.ecx_bit(12u)) result |= max_asid_value_bit_12;
            if (leaf_0x8000001f.ecx_bit(13u)) result |= max_asid_value_bit_13;
            if (leaf_0x8000001f.ecx_bit(14u)) result |= max_asid_value_bit_14;
            if (leaf_0x8000001f.ecx_bit(15u)) result |= max_asid_value_bit_15;
            if (leaf_0x8000001f.ecx_bit(16u)) result |= max_asid_value_bit_16;
            if (leaf_0x8000001f.ecx_bit(17u)) result |= max_asid_value_bit_17;
            if (leaf_0x8000001f.ecx_bit(18u)) result |= max_asid_value_bit_18;
            if (leaf_0x8000001f.ecx_bit(19u)) result |= max_asid_value_bit_19;
            if (leaf_0x8000001f.ecx_bit(20u)) result |= max_asid_value_bit_20;
            if (leaf_0x8000001f.ecx_bit(21u)) result |= max_asid_value_bit_21;
            if (leaf_0x8000001f.ecx_bit(22u)) result |= max_asid_value_bit_22;
            if (leaf_0x8000001f.ecx_bit(23u)) result |= max_asid_value_bit_23;
            if (leaf_0x8000001f.ecx_bit(24u)) result |= max_asid_value_bit_24;
            if (leaf_0x8000001f.ecx_bit(25u)) result |= max_asid_value_bit_25;
            if (leaf_0x8000001f.ecx_bit(26u)) result |= max_asid_value_bit_26;
            if (leaf_0x8000001f.ecx_bit(27u)) result |= max_asid_value_bit_27;
            if (leaf_0x8000001f.ecx_bit(28u)) result |= max_asid_value_bit_28;
            if (leaf_0x8000001f.ecx_bit(29u)) result |= max_asid_value_bit_29;
            if (leaf_0x8000001f.ecx_bit(30u)) result |= max_asid_value_bit_30;
            if (leaf_0x8000001f.ecx_bit(31u)) result |= max_asid_value_bit_31;
        }
    ...
    inline cpu_encrypted_memory_min_asid_info_mask supported_cpu_encrypted_memory_min_asid_info(const std::uint32_t max_leaf) noexcept {
        ...
        if (max_leaf >= 0x8000001F) {
            ...
            // edx register
            if (leaf_0x8000001f.edx_bit( 0u)) result |= min_asid_value_bit_0;
            if (leaf_0x8000001f.edx_bit( 1u)) result |= min_asid_value_bit_1;
            if (leaf_0x8000001f.edx_bit( 2u)) result |= min_asid_value_bit_2;
            if (leaf_0x8000001f.edx_bit( 3u)) result |= min_asid_value_bit_3;
            if (leaf_0x8000001f.edx_bit( 4u)) result |= min_asid_value_bit_4;
            if (leaf_0x8000001f.edx_bit( 5u)) result |= min_asid_value_bit_5;
            if (leaf_0x8000001f.edx_bit( 6u)) result |= min_asid_value_bit_6;
            if (leaf_0x8000001f.edx_bit( 7u)) result |= min_asid_value_bit_7;
            if (leaf_0x8000001f.edx_bit( 8u)) result |= min_asid_value_bit_8;
            if (leaf_0x8000001f.edx_bit( 9u)) result |= min_asid_value_bit_9;
            if (leaf_0x8000001f.edx_bit(10u)) result |= min_asid_value_bit_10;
            if (leaf_0x8000001f.edx_bit(11u)) result |= min_asid_value_bit_11;
            if (leaf_0x8000001f.edx_bit(12u)) result |= min_asid_value_bit_12;
            if (leaf_0x8000001f.edx_bit(13u)) result |= min_asid_value_bit_13;
            if (leaf_0x8000001f.edx_bit(14u)) result |= min_asid_value_bit_14;
            if (leaf_0x8000001f.edx_bit(15u)) result |= min_asid_value_bit_15;
            if (leaf_0x8000001f.edx_bit(16u)) result |= min_asid_value_bit_16;
            if (leaf_0x8000001f.edx_bit(17u)) result |= min_asid_value_bit_17;
            if (leaf_0x8000001f.edx_bit(18u)) result |= min_asid_value_bit_18;
            if (leaf_0x8000001f.edx_bit(19u)) result |= min_asid_value_bit_19;
            if (leaf_0x8000001f.edx_bit(20u)) result |= min_asid_value_bit_20;
            if (leaf_0x8000001f.edx_bit(21u)) result |= min_asid_value_bit_21;
            if (leaf_0x8000001f.edx_bit(22u)) result |= min_asid_value_bit_22;
            if (leaf_0x8000001f.edx_bit(23u)) result |= min_asid_value_bit_23;
            if (leaf_0x8000001f.edx_bit(24u)) result |= min_asid_value_bit_24;
            if (leaf_0x8000001f.edx_bit(25u)) result |= min_asid_value_bit_25;
            if (leaf_0x8000001f.edx_bit(26u)) result |= min_asid_value_bit_26;
            if (leaf_0x8000001f.edx_bit(27u)) result |= min_asid_value_bit_27;
            if (leaf_0x8000001f.edx_bit(28u)) result |= min_asid_value_bit_28;
            if (leaf_0x8000001f.edx_bit(29u)) result |= min_asid_value_bit_29;
            if (leaf_0x8000001f.edx_bit(30u)) result |= min_asid_value_bit_30;
            if (leaf_0x8000001f.edx_bit(31u)) result |= min_asid_value_bit_31;
        }
