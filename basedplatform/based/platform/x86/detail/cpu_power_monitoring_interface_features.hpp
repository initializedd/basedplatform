...
namespace based::platform::x86::detail {
    ...
    [[nodiscard]]
    cpu_power_monitoring_interface_feature_mask supported_cpu_power_monitoring_interface_features(const std::uint32_t max_leaf) noexcept {
        auto result = cpu_power_monitoring_interface_feature_mask{};

        if (max_leaf >= 0x80000007) {
            using cpu_power_monitoring_interface_feature;
            const auto leaf8 = cpu_id(0x80000007, 0u);

            // ecx register
            if (leaf8.ecx_bit( 0u)) result |= cpu_pwr_sample_time_ratio_bit_0;
            if (leaf8.ecx_bit( 1u)) result |= cpu_pwr_sample_time_ratio_bit_1;
            if (leaf8.ecx_bit( 2u)) result |= cpu_pwr_sample_time_ratio_bit_2;
            if (leaf8.ecx_bit( 3u)) result |= cpu_pwr_sample_time_ratio_bit_3;
            if (leaf8.ecx_bit( 4u)) result |= cpu_pwr_sample_time_ratio_bit_4;
            if (leaf8.ecx_bit( 5u)) result |= cpu_pwr_sample_time_ratio_bit_5;
            if (leaf8.ecx_bit( 6u)) result |= cpu_pwr_sample_time_ratio_bit_6;
            if (leaf8.ecx_bit( 7u)) result |= cpu_pwr_sample_time_ratio_bit_7;
            if (leaf8.ecx_bit( 8u)) result |= cpu_pwr_sample_time_ratio_bit_8;
            if (leaf8.ecx_bit( 9u)) result |= cpu_pwr_sample_time_ratio_bit_9;
            if (leaf8.ecx_bit(10u)) result |= cpu_pwr_sample_time_ratio_bit_10;
            if (leaf8.ecx_bit(11u)) result |= cpu_pwr_sample_time_ratio_bit_11;
            if (leaf8.ecx_bit(12u)) result |= cpu_pwr_sample_time_ratio_bit_12;
            if (leaf8.ecx_bit(13u)) result |= cpu_pwr_sample_time_ratio_bit_13;
            if (leaf8.ecx_bit(14u)) result |= cpu_pwr_sample_time_ratio_bit_14;
            if (leaf8.ecx_bit(15u)) result |= cpu_pwr_sample_time_ratio_bit_15;
            if (leaf8.ecx_bit(16u)) result |= cpu_pwr_sample_time_ratio_bit_16;
            if (leaf8.ecx_bit(17u)) result |= cpu_pwr_sample_time_ratio_bit_17;
            if (leaf8.ecx_bit(18u)) result |= cpu_pwr_sample_time_ratio_bit_18;
            if (leaf8.ecx_bit(19u)) result |= cpu_pwr_sample_time_ratio_bit_19;
            if (leaf8.ecx_bit(20u)) result |= cpu_pwr_sample_time_ratio_bit_20;
            if (leaf8.ecx_bit(21u)) result |= cpu_pwr_sample_time_ratio_bit_21;
            if (leaf8.ecx_bit(22u)) result |= cpu_pwr_sample_time_ratio_bit_22;
            if (leaf8.ecx_bit(23u)) result |= cpu_pwr_sample_time_ratio_bit_23;
            if (leaf8.ecx_bit(24u)) result |= cpu_pwr_sample_time_ratio_bit_24;
            if (leaf8.ecx_bit(25u)) result |= cpu_pwr_sample_time_ratio_bit_25;
            if (leaf8.ecx_bit(26u)) result |= cpu_pwr_sample_time_ratio_bit_26;
            if (leaf8.ecx_bit(27u)) result |= cpu_pwr_sample_time_ratio_bit_27;
            if (leaf8.ecx_bit(28u)) result |= cpu_pwr_sample_time_ratio_bit_28;
            if (leaf8.ecx_bit(29u)) result |= cpu_pwr_sample_time_ratio_bit_29;
            if (leaf8.ecx_bit(30u)) result |= cpu_pwr_sample_time_ratio_bit_30;
            if (leaf8.ecx_bit(31u)) result |= cpu_pwr_sample_time_ratio_bit_31;
        }
